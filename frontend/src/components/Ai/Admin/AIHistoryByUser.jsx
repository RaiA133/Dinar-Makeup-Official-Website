  ...
  return (
    <>
      <section className="flex justify-center">
        <div className="overflow-x-auto rounded-box border border-base-content/5 bg-base-100 mb-3 w-full shadow-sm max-h-[80vh] overflow-auto">
          ...
          {[...Array(totalPages)].map((_, i) => {
            ...
            return (
              <input
                ...
                onChange={() => navigate(`/admin/ai?limit=10&page=${pageNum}`)}
              />
            );
          })}
        </div>
